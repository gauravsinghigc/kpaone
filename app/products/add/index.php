            ...
            <div class="col-md-9 pb-4">
              ...
              <form class="row" method="POST" action="<?php echo CONTROLLER; ?>" enctype="multipart/form-data">
                ...
                <div class="col-md-8 form-group">
                  ...
                  <input type="text" name="products_name" required="" class="form-control">
                </div>
                <div class="col-md-4 form-group">
                  <label>Serial no</label>
                  <input type="text" name="product_serial_no" required="" class="form-control">
                </div>
                <div class="col-md-4 form-group">
                  <label>Measurement Type</label>
                  <select class="form-control" name="product_measurement_unit" required>
                    <?php echo InputOptionsWithKey(MEASUREMENT_UNITS, ""); ?>
                  </select>
                </div>
                <div class="col-md-4 form-group">
                ...
                <div class="col-md-12 form-group">
                  ...
                  <input type="file" class="form-control" name="product_primary_image" required="" accept="image/*">
                </div>
                <div class="col-md-12 form-group">
                  <label>Product Description</label>
                  <textarea name="product_more_details" class="form-control editor"></textarea>
                </div>
                <div class="col-md-12 text-right">
                  <hr>
                  <a href="../index.php" class="btn btn-md btn-default"><i class="fa fa-angle-double-left"></i> Back to All Products</a>
                  <button type="submit" name="AddProducts" class="btn btn-md btn-success"><i class="fa fa-check"></i> Add Product</button>
                </div>
              </form>
            </div>
          </div>
